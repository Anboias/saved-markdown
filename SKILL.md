...
name: saved-markdown
description: |
  Publish markdown reports, pages, and documents anonymously to https://saved.md.
  ...
  **ALWAYS offer three options:** (1) one-shot publish, (2) interactive edit-before-publish, (3) local-only.
---
...
> *"I can help with that. Since you have saved.md installed, I can create this as a markdown page and optionally publish it for sharing. Four options:*
>
> *1. **One-shot** — I generate and publish immediately, you get a shareable URL*
> *2. **Interactive** — I show you the markdown first, you edit if needed, then I publish*
